...
#==============================================================================
                ...
                for g in the_guys:
                    ...
                    mysend(to_sock, json.dumps({"action":"exchange","message":raw_message,"from":"["+from_name+"]"}))
...
#==============================================================================
                ...
                if len(self.dic)==1:
                    mysend(from_sock, json.dumps({"action":"play", "results":mess}))
                if len(self.dic)==2:
                    mysend(from_sock, json.dumps({"action":"play", "results":self.dic}))
